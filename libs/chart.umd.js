...
!(function (t, e) {
  ...
  function n(t) {
    ...
    return (
      "[object" === e.slice(0, 7) && "Array]" === e.slice(-6)
    );
  }
  function o(t) {
    return (
  ...
  function te(t) {
    return Zt(t)
      ? t
      : new Jt(t).saturate(0.5).darken(0.1).hexString();
  }
  ...
  function Zi(t, e) {
    return t.filter(
      (t) => -1 === Gi.indexOf(t.pos) && t.box.axis === e
    );
  }
  function Qi(t, e) {
    return t.sort((t, i) => {
  ...
  function ss(t, e, i, s) {
    ...
    const l = Math.max(
        0,
        e.outerWidth - es(r, t, "left", "right")
      ),
  ...
  function xs(t, e, i) {
    ...
    return (
      n.observe(document, { childList: !0, subtree: !0 }), n
    );
  }
  function bs(t, e, i) {
    const s = t.canvas,
  ...
  class Ss extends hs {
    ...
    removeEventListener(t, e) {
      const i = t.$proxies || (t.$proxies = {}),
        s = i[e];
      if (!s) return;
      (({ attach: ws, detach: ws, resize: ws })[e] || ps)(
        t,
        e,
        s
      ),
  ...
  class As {
    ...
    tick(t) {
      ...
      let r;
      if (
        ((this._active = n !== a && (o || e < i)), !this._active)
      )
  ...
  class Ts {
    ...
    configure(t) {
      ...
      Object.getOwnPropertyNames(t).forEach((s) => {
        ...
        ((n(a.properties) && a.properties) || [s]).forEach(
          (t) => {
  ...
  class js {
    ...
    updateRangeFromParsed(t, e, i, s) {
      ...
      s &&
        a &&
        ((s.values = a), (o = Rs(s, n, this._cachedMeta.index))),
  ...
  function Ys(t, e) {
    ...
    if (r > 0) {
      ...
      for (
        Us(e, c, d, s(n) ? 0 : l - n, l), t = 0, i = r - 1;
        t < i;
        t++
      )
        Us(e, c, d, a[t], a[t + 1]);
  ...
  function Zs(t, e) {
    ...
    const i = Si(t.font, e),
      s = ki(t.padding);
    return (
      (n(t.text) ? t.text.length : 1) * i.lineHeight + s.height
    );
  }
  function Qs(t, e, i) {
    let s = ut(t);
  ...
  class tn extends $s {
    ...
    _maxDigits() {
      ...
      return (
        (this.isHorizontal() ? this.width : this.height) / t
      );
    }
  }
  class en {
  ...
  function zn(t) {
    ...
    const l = () => {
      32767 !== o &&
        -32768 !== o &&
        (k(a) && (r = Math.min(r, Math.abs(o - a) || r)),
        (a = o));
    };
  ...
  class $n extends js {
    ...
    _getRingWeight(t) {
      return Math.max(
        l(this.chart.data.datasets[t].weight, 1),
        0
      );
    }
    ...
    LineController: class extends js {
      ...
      updateElements(t, e, i, n) {
        const o = "reset" === n,
          ...
          x =
            this.chart._animationsDisabled || o || "none" === n,
          b = e + i,
          _ = t.length;
  ...
  function eo(t, e, i, s) {
    ...
    for (
      l && ((d = n[b(0)]), t.moveTo(d.x, d.y)), c = 0;
      c <= r;
      ++c
    ) {
    ...
    buildTicks() {
      ...
      const n = (function (t, e) {
        ...
        return (
          b && u && w !== r
            ? i.length &&
              V(i[i.length - 1].value, r, xo(r, y, t))
  ...
  class _o extends bo {
    static id = "linear";
    static defaults = {
      ticks: { callback: ae.formatters.numeric },
    };
    determineDataLimits() {
  ...
  class So extends tn {
    ...
    handleTickRangeOptions() {
      ...
      const n = (e) => (i = t ? i : e),
        o = (t) => (s = e ? s : t);
      i === s &&
        (i <= 0 ? (n(1), o(10)) : (n(vo(i, -1)), o(vo(s, 1)))),
        i <= 0 && n(vo(s, -1)),
        s <= 0 && o(vo(i, 1)),
        (this.min = i),
        (this.max = s);
  ...
  class Ho extends tn {
    ...
    determineDataLimits() {
      ...
      (o && r) ||
        ...
        (n =
          a(n) && !isNaN(n) ? n : +e.endOf(Date.now(), i) + 1),
    ...
    _generate() {
      const t = this._adapter,
        ...
        o =
          n.unit ||
          Bo(n.minUnit, e, i, this._getLabelCapacity(e)),
  ...
  var $o = Object.freeze({
    ...
    CategoryScale: class extends tn {
      ...
      buildTicks() {
        ...
        (n =
          0 === t && e === n.length - 1 ? n : n.slice(t, e + 1)),
            ...
            f = (function (t, e, i, s, n) {
              ...
              for (a[l++] = t[p], c = 0; c < o - 2; c++) {
                ...
                const h = Math.floor((c + 1) * r) + 1 + e,
                  m =
                    Math.min(Math.floor((c + 2) * r) + 1, i) + e,
                  x = m - h;
                for (s = h; s < m; s++)
                  (n += t[s].x), (o += t[s].y);
                (n /= x), (o /= x);
                const b = Math.floor(c * r) + 1 + e,
                  _ =
                    Math.min(Math.floor((c + 1) * r) + 1, i) + e,
                  { x: y, y: v } = t[p];
                for (u = f = -1, s = b; s < _; s++)
                  (f =
                    0.5 *
    ...
    _draw() {
      ...
      this.legendItems.forEach((y, v) => {
        ...
        const M = s.measureText(y.text).width,
          w = r.textAlign(
            y.textAlign || (y.textAlign = o.textAlign)
          ),
          k = g + u + M;
        let S = f.x,
          P = f.y;
